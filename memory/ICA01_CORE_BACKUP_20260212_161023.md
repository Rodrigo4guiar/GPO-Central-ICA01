...
<head>
    ...
    <style>
        :root { --neon: #00ffcc; --bg: #0b0f14; --panel: rgba(10, 25, 35, 0.85); --red: #ff003c; }
        body { background: var(--bg); color: #b7ffd6; font-family: 'Courier New', monospace; padding: 20px; min-height: 100vh; }
...
<body>
    ...
    <script>
        // PERSISTÊNCIA LOCAL (LocalStorage) para não perder dados ao fechar
            ...
            db.despesas.forEach(d => {
                ...
                lista.innerHTML += `
                    <tr>
                        ...
                        <td>
                            <button class="btn-pay" onclick="pagarParcela(${d.id})"><i class="fas fa-check"></i> Pagar</button>
